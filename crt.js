...
module.exports = function Cloudflare() {
 ...
 if (process.argv.length < 8){console.log(`rizz\n Usage: node CRT-X.js.js target time thread proxy.txt rate uam/captha\nExample: node CRT-X https;//example.com 120 10 proxy.txt 32 uam`); process.exit();}
 const headers = {};
...
console.log(`Random_Method:` + lintarMethod)
console.log(`--------------------------------------------`)
console.log(`Methods: CRT-X`)
console.log(`Rizz`)
console.log(`--------------------------------------------`)
